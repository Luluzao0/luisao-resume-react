...
export const translations: Translations = {
  ...
  'about.description': {
    pt: 'Luis Lopes. Bem-vindo ao meu espaço na web! Com anos de jornada profissional, me especializo em criar soluções inovadoras para desafios de software. Proficiente em metodologias ágeis, possuo amplo conhecimento das principais linguagens e tecnologias de desenvolvimento web. Trabalhei como Desenvolvedor de Software na Technos Engenharia, São Luís / TELUS International, Vancouver, focando em desenvolvimento de páginas responsivas, otimização de performance e testes rigorosos. Formado em Engenharia da Computação pela Universidade Estadual do Maranhão, com foco atual de pesquisa em aprimoramento de performance de sistemas web e bancos de dados no Laboratório de Processamento de Sinais (LAPS).',
    en: "Luis Lopes. Welcome to my corner of the web! With years in professional journey, I specialize in crafting innovative solutions to software challenges. Proficient in agile methodologies, I possess extensive knowledge of leading web development languages and technologies. Worked as a Software Developer at Technos Engenharia, São Luís / TELUS International, Vancouver, focusing on responsive page development, performance optimization, and rigorous testing. Holds a degree in Computer Engineering from Universidade Estadual Do Maranhão, with a current research focus on enhancing web system and database performance at the Signal Processing Laboratory (LAPS)."
  },
